...
// Must comfortably exceed the cumulative worst-case fee escrow
// (gas_limit x max_fee per tx) across a full multi-hour stress run: the
// builder rejects any XT whose sender cannot cover the escrow of every tx,
// and 0.05 ETH drained below a single receive tx's escrow within minutes.
const ETH_FUND_CHAIN_A = ethers.parseEther('2')
const ETH_FUND_CHAIN_B = ethers.parseEther('2')
